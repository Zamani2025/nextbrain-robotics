...
<head>
    ...
    <title>NextBrain Robotics Blog Page</title>
    @livewireStyles()
</head>
<body>
     <!-- Spinner Start -->
    ...
    <div class="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center">
            <h1 class="display-4 text-white animated slideInDown mb-4">Online Registeration Form</h1>
        </div>
    </div>
   {{$slot}}
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 text-center text-md-end">
                        ...
                        Designed By <a href="https://htmlcodex.com">Xamani</a>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        $("input#test-checkbox1").click(function(){
            $("#test-show").slideDown();
            $("input.disabled").removeAttr("disabled");
        });
        $("input#test-checkbox2").click(function(){
            $("#test-show").slideUp();
        });
    });
</script>
